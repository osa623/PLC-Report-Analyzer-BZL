...
class ExtractionService:
    ...
    def _prepare_chunk_text(cls, text: str) -> str:
        ...
        raw_l = text.lower()
        decoded_l = decoded.lower()
        signal_terms = ("equity", "capital", "retained", "dividend", "reserve")
    ...
    def process(self, report_id: str, file_path: str = None) -> str:
        ...
        observability_trace = self.observability.trace_context(report_id, "equity_statement")
        ...
        confidence_result = self.confidence.score("equity_statement", normalized_records, {"errors": validation_errors})
