...
class TransformationService:
    _SEMANTIC_MAP: dict[str, tuple[str, ...]] = {
        "balance_beginning": ("balance", "beginning", "april", "january"),
        "profit_loss": ("profit for the year", "loss for the year", "net profit"),
        "total_comprehensive_income": ("total comprehensive income",),
        "dividends": ("dividend", "distribution"),
        "balance_end": ("balance", "end", "march", "december"),
        "issue_shares": ("issue of shares", "rights issue"),
    }
