...
Use the following as the canonical, completed structure references:

1. `CURRENT_PROJECT_FLOW.md` for target runtime behavior and mandatory gating rules.
2. `docs/architecture/DATA_FIRST_PROJECT_STRUCTURE.md` for the completed folder structure.
3. `docs/architecture/DATA_FIRST_DEEP_SUMMARY.md` for the full deep implementation summary.
