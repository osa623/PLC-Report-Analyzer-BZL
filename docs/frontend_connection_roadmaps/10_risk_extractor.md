# risk_extractor - Frontend Connection Roadmap

## Service Role
Extracts risk disclosures and risk narrative structure.

## Base URL
- Local direct: http://localhost:8009
- Docker direct: http://localhost:8009
...
## Integration Notes
Designed as an internal pipeline component rather than a public frontend endpoint.
