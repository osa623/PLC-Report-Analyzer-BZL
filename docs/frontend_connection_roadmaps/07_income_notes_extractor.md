# income_notes_extractor - Frontend Connection Roadmap

## Service Role
Extracts domain financial rows and supports async batch job execution.

## Base URL
- Local direct: http://localhost:not_in_compose_default
- Docker direct: http://localhost:not_in_compose_default
