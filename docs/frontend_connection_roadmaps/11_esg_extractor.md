# esg_extractor - Frontend Connection Roadmap

## Service Role
Extracts ESG and sustainability disclosures.

## Base URL
- Local direct: http://localhost:8010
- Docker direct: http://localhost:8010
...
## Integration Notes
Use report view endpoint from orchestrator to read normalized ESG output in one consolidated payload.
