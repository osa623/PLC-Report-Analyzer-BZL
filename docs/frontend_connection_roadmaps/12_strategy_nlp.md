# strategy_nlp - Frontend Connection Roadmap

## Service Role
Extracts strategy narratives and business model insights.

## Base URL
- Local direct: http://localhost:8011
- Docker direct: http://localhost:8011

## Recommended Frontend Access Pattern
Prefer indirect access via node_orchestrator pipeline.

## Endpoints
- POST /extract-strategy
- GET /health
...
## Integration Notes
Currently no async jobs endpoint; integrate as synchronous call when used directly.
