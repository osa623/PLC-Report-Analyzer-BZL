...
//import webicon_II from '../assets/Header/bullNavBar1.png';

//UI Components
import ScrollVelocity from "@/components/Ui/ScrollVelocity";
import AllStocksSection from '../Pages/Dashboard/AllStocksSection';
                  ...
                  >
                   {stocks?.reqTradeSummery?.map((stock, index) => (
                      <div key={index} className="flex items-center space-x-2 mx-6">
                        <span className="text-[#B28D41] font-jetbrains">{stock.symbol}</span>
            ...
            <div className="flex items-center px-6">
              <Link href="/" className="group flex items-center">
                <div className="relative">
                  ...
                  <Image src={webicon_I} alt="Logo" className="w-20 h-auto object-cover object-center flex" />
                </div>
